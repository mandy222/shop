	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="findAllGoodsInfoServlet" class="active-menu"><i
						class="fa fa-qrcode"></i> 商品管理</a></li>
				<li><a href="#"><i class="fa fa-sitemap"></i>预销售管理<span
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="table-responsive">
									<form action="updateGoodsInfoServlet">
										<table class="table table-striped table-bordered table-hover"
											...
											<%
												...
												while (it.hasNext()) {
													gd = (GoodsDTO) it.next();
													if ((gd.getGid()).equals(gid)) {
											%>
											<tbody>
												<tr>
													<td><input type="text" name="gid"
														value=<%=gd.getGid()%> readonly></td>
													<td><input type="text" name="gname"
														value=<%=gd.getGname()%>></td>
													<td><input type="text" name="price"
														value=<%=gd.getPrice()%>></td>
													<td><input type="text" name="count"
														value=<%=gd.getCount()%>></td>
